...
- Task start: [src/background/service-worker.js](../src/background/service-worker.js#L1190)
- Follow-up messages: [src/background/service-worker.js](../src/background/service-worker.js#L1431)
- Screenshot handling: [src/background/service-worker.js](../src/background/service-worker.js#L1621)
- Main browser loop: [src/background/service-worker.js](../src/background/service-worker.js#L498)

The MCP server entrypoint forwards to that path:

- MCP tools: [server/src/index.ts](src/index.ts)
- Relay client: [server/src/ipc/websocket-client.ts](src/ipc/websocket-client.ts)
...
See: [server/src/relay/server.ts](src/relay/server.ts)
...
See: [src/background/modules/mcp-bridge.js](../src/background/modules/mcp-bridge.js)
...
See: [src/background/service-worker.js](../src/background/service-worker.js)
...
- utility/legacy references to native-host transport in [server/src/ipc/native-host.ts](src/ipc/native-host.ts)
- utility/legacy references to native-host transport in [server/src/ipc/index.ts](src/ipc/index.ts)
...
See [PRODUCTION_READINESS.md](docs/internal/PRODUCTION_READINESS.md)
